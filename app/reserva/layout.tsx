...
export const metadata: Metadata = {
  title: "Reserva de Vehículo — Quiroz Automotriz",
  description:
    "Reserva tu vehículo con $200.000. Aseguramos tu compra, retiramos la publicación de todas las plataformas y te garantizamos el precio. Concón y Valparaíso.",
  openGraph: {
    title: "Reserva de Vehículo — Quiroz Automotriz",
    description:
