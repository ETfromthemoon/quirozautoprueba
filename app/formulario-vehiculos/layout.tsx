...
export const metadata: Metadata = {
  title: "Formulario de Vehículo — Quiroz Automotriz",
  description:
    "Vende tu auto de forma segura o consigna tu vehículo. Respuesta rápida, pago al instante, trámites incluidos. Concón y Valparaíso.",
  openGraph: {
    title: "Formulario de Vehículo — Quiroz Automotriz",
    description:
