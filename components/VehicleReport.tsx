...
export default function VehicleReport({ car, report, demo = false }: Props) {
  const all: Definition[] = [
    ...
    { id: "equipamiento", index: "08", title: "Equipamiento", overline: "Funciones verificadas", module: report.equipamiento, groups: [{ observationKey: "observaciones", rows: [["A/C", "aireAcondicionado"], ["Calefacción", "calefaccion"], ["Climatizador", "climatizador"], ["Alzavidrios", "alzavidrios"], ["Cierre central", "cierreCentral"], ["Radio", "radio"], ["Airbags", "airbags"], ["Cinturones", "cinturones"], ["Gata", "gata"], ["Llave de rueda", "llaveRueda"], ["Kit de seguridad", "kitSeguridad"]] }] }
  ];
